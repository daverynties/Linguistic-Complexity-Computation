...
file = 'C:\\Users\\drynties.EA\\repos\\linguistic_complexity\\alice_in_wonderland.txt'
...
for index, value in enumerate(total_complexity, start=1):
    if index % 15 == 0:
        plt.scatter(index, value, s=5)
